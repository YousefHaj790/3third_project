...
const Navigate=useNavigate()
  ...
  const Register = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:3003/profile/users/Register", {
        method: "POST",
        body: formData,
      });
...
Navigate('/');
      ...
      }} width="40" style={{marginLeft:'2rem',cursor:"pointer"}} height="40" src="https://img.icons8.com/ios/50/circled-left-2.png" alt="circled-left-2"/>

      <form style={{ display: hideOrShow }} className="LOGIN" onSubmit={Register}>
